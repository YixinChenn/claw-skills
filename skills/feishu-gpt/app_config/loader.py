...
def load_settings() -> AppSettings:
    ...
    return AppSettings(
        ...
        doc_import_cli_as=str(getattr(module, "DOC_IMPORT_CLI_AS", "user") or "user"),
        ...
        doc_import_local_index_path=str(getattr(module, "DOC_IMPORT_LOCAL_INDEX_PATH", "doc_sources/Document_Index.md") or "doc_sources/Document_Index.md"),
        doc_import_online_index_doc=str(getattr(module, "DOC_IMPORT_ONLINE_INDEX_DOC", "") or ""),
        doc_import_bot_author_enabled=bool(getattr(module, "DOC_IMPORT_BOT_AUTHOR_ENABLED", True)),
